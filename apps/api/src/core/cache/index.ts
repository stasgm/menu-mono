...
export class CacheConfigService implements CacheOptionsFactory<RedisClientOptions> {
  createCacheOptions():
    | CacheModuleOptions<RedisClientOptions<RedisModules, RedisFunctions, RedisScripts>>
    | Promise<CacheModuleOptions<RedisClientOptions<RedisModules, RedisFunctions, RedisScripts>>> {
    return {
