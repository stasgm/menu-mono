...
import { CustomFlowbiteTheme, Pagination as SourcePagination } from 'flowbite-react';
...
export default function Pagination({ currentPage, onPageChange, totalPages }: IPagination) {
  return (
    <SourcePagination
      theme={customTheme}
